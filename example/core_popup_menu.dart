 ...
 */
library core_elements.example.core_popup_menu;

import 'package:polymer/polymer.dart';
export 'package:polymer/init.dart';

@CustomTag('menu-button')
class MenuButton extends PolymerElement {
  @published var icon;
  @published var opened;
  @published var halign;
  @published var valign;

  MenuButton.created() : super.created();
...
@CustomTag('popup-menu-demo')
class PopupMenuDemo extends PolymerElement {
  ...
  PopupMenuDemo.created() : super.created();
}
